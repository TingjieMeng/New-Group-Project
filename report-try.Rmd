...
```
=======
>>>>>>> b3548aabd2e971c7f25a7b9a292753aa3ff0c9d4
...
# Liumin: Can I change it into final_data = df?
```{r}
...
table1
```
The explanation of the logit model output

# Liumin: Do you need this plot?
```{r}
