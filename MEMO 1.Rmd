...
All the three data sources are publicly available. The World Bank and IMF APIs can be installed in R, and the Polity IV Project data can be conveniently downloaded as a csv package.  

\section{Potential Issues}

First, since our project focuses on EMEs, it is anticipated that the dataset will contain more missing values and reporting bias. It is more difficult to obtain macroeconomic data on less developed countries because of bureaucratic mismanagement and officials' incentive to inflate their economic data. 

Second, domestic political instability is an important trigger of bond selloff and capital outflow. However, we have not found an effective and direct measure of political stability. The Polity Score published by Center for Systemic Peace is the closest measure we find, but it only gauges the level of democracy, not the level of political stability. This introduces bias into our model, as countries like China are assigned low polity scores but in fact have stable political systems.
