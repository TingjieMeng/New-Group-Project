...
```{r,include=TRUE,fig.align="center",fig.width=6,fig.height=9}
table1 <- screenreg(m)
table1
```
...
```{r,include=FALSE}
# ! [] (/Users/Meng/Desktop/Spring2019/DataScience/group project/new project/New-Group-Project/graphs/logit.jpg)
```
