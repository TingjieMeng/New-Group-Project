...
figure1 <- ggplot(df1,aes(year,externaldebtgni))+
  ...
  labs(x="year",
       y="external debt/GNI",
       title="figure 1: Higher xternal debt, More currency crisis?",
...
```{r,inclue=TRUE, fig.align="center", fig.height=5,fig.width=7}
#graph 5 is figure 3
...
figure3 <- ggplot(df1,aes(year,totalreservesoutoftotalexternald))+
  ...
  labs(title="figure 3: Lower foreign reserves, more currenct crisis",caption="Source: IMF, the World Bank") +
  theme(legend.position = 'bottom',
    plot.title = element_text(hjust=.5),
        plot.subtitle = element_text(hjust=.5))+
  facet_wrap(~countryx)+
...
```{r,include=TRUE, fig.align="center", fig.height=5,fig.width=7}
#figure 4
...
figure4 <- ggplot(df1,aes(year,polity2))+
  ...
  geom_point(aes(year,color=currencycrisis))+
  ylab("polity score")+
  labs(title="figure 4: Higher polity score, More currency crisis?",caption="Source: IMF,the World Bank,\n the Center for Systemic Peace") +
  theme(legend.position = "bottom",
    plot.title = element_text(hjust=.5),
        plot.subtitle = element_text(hjust=.5))+
  facet_wrap(~countryx)+
...
```{r,include=TRUE, fig.align="center",fig.height=5,fig.width=7.5}
#figure 5
figure5 <- ggplot(df1,aes(x=year))+
  ...
  facet_wrap(~countryx)+
  theme(legend.position = "bottom")+
  labs(title="figure 5: Higher Polity Score, Higher GDP per capita?",
       caption="Source: IMF,the World Bank,\n the Center for Systemic Peace") +
  theme(legend.position = "bottom",
        plot.title = element_text(hjust=.5),
        plot.subtitle = element_text(hjust=.5))+
...
partialmerge <- annotate_figure(partial,
                top = text_grob("figure 6: Partial dependency plot",size = 14),
